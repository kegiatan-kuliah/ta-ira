...
<div class="row mb-2">
  <div class="col-sm-6">
    <h1>Tambah Surat Masuk External</h1>
  </div>
  <div class="col-sm-6">
    <ol class="breadcrumb float-sm-right">
      <li class="breadcrumb-item"><a href="#">Home</a></li>
      <li class="breadcrumb-item active">Tambah Surat Masuk External</li>
    </ol>
  </div>
</div>
@endsection
@section('content')
{{ html()->form('POST', route('in_ex.store'))->attribute('enctype', 'multipart/form-data')->open() }}
  <div class="card">
